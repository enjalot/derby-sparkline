...
exports.create = function(model, dom) {
  var mySparkline = sparkline()
  mySparkline.xValue(function(d) { return d.x; });
  mySparkline.yValue(function(d) { return d.y; });

  mySparkline.width(model.get('width'))
  mySparkline.height(model.get('height'))
